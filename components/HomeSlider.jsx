      ...
      {sliderData.map((el) => {
        if (el.id === actualSlide) {
          return (
            <>
              <div>
                <div key={el.id} className={styles.sliderContainer} style={{ backgroundImage: `url(${`/images/slider-${actualSlide}.jpg`})`, }}>
                ...
                <div className={styles.position}>
                  {sliderData.map((el, index) => {
                    if (index + 1 === actualSlide) {
                      ...
                      return <div className={styles.positionDot} key={el.id}></div>
                      }
                  })}
                </div>
              </div>
